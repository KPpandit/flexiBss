...
import { Add, Delete, Save, Storage } from "@mui/icons-material"

export default function ScheduleInventoryReport() {
  const [enabled, setEnabled] = useState(true)
  const [scheduleTime, setScheduleTime] = useState("11:00")
  const [frequency, setFrequency] = useState("daily")
  const [recipients, setRecipients] = useState(["inventory@company.com", "operations@company.com"])
  ...
  const handleSave = () => {
    setSnackbar({
      open: true,
      message: "Inventory Report schedule configuration saved successfully!",
      severity: "success",
    })
  }
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
        <Storage sx={{ fontSize: 32, mr: 2, color: "primary.main" }} />
        <Typography variant="h4" sx={{ fontWeight: 600 }}>
          Schedule Inventory Report
        </Typography>
      </Box>
